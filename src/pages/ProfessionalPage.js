      ...
      <div className="page professional_page">
        ...
        <section className="text_wrapper full-stack">
          ...
          */}
          ...
          <p>Technologies/tools I've used professionally: HTML, CSS, JS, PHP, Ruby, ASP, ASP.net, SQL, jQuery, Vue, Visual Basic, XML, JSON, WordPress, Drupal, Ruby on Rails, CakePHP, Slim, Capistrano, Jenkins, Visual Studio, Sublime Text, Atom, Flash, ImageMagick, Photoshop, ImageOptim, Word, Excel, PowerPoint, Google Suite, Redmine, Jira, Github, Bitbucket.</p>
